...
function Signup() {
   ...
   const [data, setData]= useState({FirstName:"", LastName:"", UserName:"",Email:"", Phone:"", Password:"", ConfirmPassword:"",  })
    ...
    <div> 
        ...
        <div className='signup-content-two'>
         ...
         <div className='signup-name' >
            ...
            <input type='text' placeholder='Last Name' name='LastName' onChange={handleChange} value={data.LastName}/><br/></div> 
            <input type='text' placeholder='UserName' name='UserName' onChange={handleChange} value={data.UserName}/><br/>
            <input type='email' placeholder='Email ' name='Email' onChange={handleChange} value={data.Email}/><br/>
            <input type='phone' placeholder='Phone ' name='Phone' onChange={handleChange} value={data.Phone}/><br/>
            <input type='password' placeholder='Password' name='Password' onChange={handleChange} value={data.Password}/><br/>
            <input type='password' placeholder='Confirm Password' name='ConfirmPassword' onChange={handleChange} value={data.ConfirmPassword}/><br/>
