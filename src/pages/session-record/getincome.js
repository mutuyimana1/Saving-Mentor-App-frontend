      ...
      <h2>INCOME RECORDS</h2>
              ...
              <div>
                 ...
                 <div className="lie"></div>
                  ...
                  <div className="twe">
                      <div className="iconic">  <i class='bx bx-filter-alt' ></i></div>
                      <div className="conic"><p>May 2023</p> <i class='bx bxs-down-arrow' ></i></div>
                      <div className="onic"><p>Source</p>  <i class='bx bxs-down-arrow' ></i></div>
                      <div className="nic"><p>Report Specific Filters</p>  <i class='bx bxs-down-arrow' ></i></div>
                  </div>
                  <br/>
                  <br/> 
                  ...
                  <div className="al">
                    ...
                    <table>
                      ...
                      <tr>
                        ...
                        <td>Monthly</td>
                        <td>19:34 PM</td>
                        <td><button className="butn">Examine</button></td>
