      ...
      <div className="divv">
        ...
        <div>
          ...
          <div className="two">
            ...
            <div className="ic">
              <p>Sessions</p> <i class="bx bxs-down-arrow"></i>
            </div>
            <div className="io">
          ...
          <div className="three">
            <div className="table">
              <table border={0}>
                ...
                <tr>
                  <td>
                    <input type="checkbox" className="box" /> Kigali-Rwanda
                  </td>
                  <td>3</td>
                  <td>4:35</td>
                  <td>
                    <i class="bx bx-laptop"></i>/<i class="bx bxl-chrome"></i>/
                    <i class="bx bxl-windows"></i>
                  </td>
                  <td>14:29 PM</td>
                  <td>
                    <button className="botn">PLAY</button>
                  </td>
                </tr>

                <tr>
                  <td>
                    <input type="checkbox" className="box" /> Bugesera-Rwanda
                  </td>
                  <td>5</td>
                  <td>2:45</td>
                  <td>
                    <i class="bx bx-mobile"></i>/<i class="bx bxl-chrome"></i>/
